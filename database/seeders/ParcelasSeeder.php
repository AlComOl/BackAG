...
class ParcelasSeeder extends Seeder
{
    public function run(): void
    {
        $parcelas = [
            ...
            [
                'explotacion_id' => 1, // Casa el Pi - Guadasuar
                'propietarios_id' => 1,
                'rol' => 'manta',
                'poligono' => 5,
                'parcela' => 41,
            ...
            [
                'explotacion_id' => 3, // Tosalet
                'propietarios_id' => 1,
                'rol' => 'goteo',
                'poligono' => 24,
                'parcela' => 1041,
                'variedad' => 'Okitsu Triturado poda',
